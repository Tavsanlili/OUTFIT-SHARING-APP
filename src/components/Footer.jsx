    ...
    <footer className="bg-gradient-to-r from-purple-900 via-purple-800 to-pink-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-purple-200 text-sm">
              Discover, share, and get inspired by amazing outfit combinations from fashion lovers around the world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-purple-200 hover:text-yellow-200 transition-colors duration-200"
                >
                  Home
                </Link>
              </li>
        ...
        <div className="border-t border-purple-600 mt-8 pt-6 text-center">
          <p className="text-purple-200 text-sm">
            © {currentYear} Sharing APP. All rights reserved. | Created with 💜 by <span className="text-yellow-200 font-semibold">Koray Tavşanlılı</span>
          </p>
        </div>
      </div>
    </footer>
